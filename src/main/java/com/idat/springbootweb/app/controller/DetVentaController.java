...
import com.idat.springbootweb.app.service.IDetalleVentaService;
...
public class DetVentaController {
	@Autowired
	private IDetalleVentaService detventaDao;

	@GetMapping("/detventa")
	public List<DetalleVenta> index(){
		return detventaDao.listarDetVenta();
	}
	

	@PostMapping("/detventa")
	public DetalleVenta create(@RequestBody DetalleVenta detventa  ){
		return detventaDao.crearDetVenta(detventa);
	}
